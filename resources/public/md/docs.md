...
Two middleware functions are provided by default in the `flight-log.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `flight-log.handler` namespace to manage the enabled middleware.
